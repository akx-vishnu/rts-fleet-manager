...
export class ShiftsService {
  ...
  async update(id: string, updateShiftDto: any) {
    ...
    if (updateShiftDto.dayOfWeek !== undefined)
      updateData.day_of_week = updateShiftDto.dayOfWeek;
    if (updateShiftDto.isActive !== undefined)
      updateData.is_active = updateShiftDto.isActive;
    if (updateShiftDto.effectiveFrom)
      updateData.effective_from = updateShiftDto.effectiveFrom;
    if (updateShiftDto.effectiveUntil !== undefined)
      updateData.effective_until = updateShiftDto.effectiveUntil;
