...
export const rosterAssignmentEmployees = pgTable(
  'roster_assignment_employees',
  {
    id: uuid('id').defaultRandom().primaryKey(),
    roster_assignment_id: uuid('roster_assignment_id')
...
export const rosterAssignmentEmployeesRelations = relations(
...
export const rotationTrackingRelations = relations(
  rotationTracking,
  ({ one }) => ({
    driver: one(drivers, {
