  ...
  const sampleRoutes = [
    {
      ...
      stops: [
        ...
        { name: 'GP Signal', lat: 11.025, lng: 76.965, type: StopType.PICKUP },
        { name: 'Ganapathy', lat: 11.037, lng: 76.975, type: StopType.PICKUP },
        {
          name: 'Sathy Road CMC Colony',
          lat: 11.05,
          lng: 76.985,
          type: StopType.PICKUP,
        },
        {
          name: 'Saravanampatti IT Park',
          lat: 11.0768,
          lng: 77.0168,
          type: StopType.PICKUP,
        },
    ...
    },
    {
      ...
      stops: [
        ...
        {
          name: 'PN Pudur Signal',
          lat: 11.045,
          lng: 76.92,
          type: StopType.PICKUP,
        },
        {
          name: 'Edayarpalayam Junction',
          lat: 11.055,
          lng: 76.925,
          type: StopType.PICKUP,
        },
        {
          name: 'Thudiyalur Market',
          lat: 11.0768,
          lng: 76.9416,
          type: StopType.PICKUP,
        },
